 ...
 */
class Proprietaire extends \HTL\ImmobilierBundle\Entity\Proprietaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'HTL\\ImmobilierBundle\\Entity\\Proprietaire' . "\0" . 'id', '' . "\0" . 'HTL\\ImmobilierBundle\\Entity\\Proprietaire' . "\0" . 'numPiece', '' . "\0" . 'HTL\\ImmobilierBundle\\Entity\\Proprietaire' . "\0" . 'nomComplet', '' . "\0" . 'HTL\\ImmobilierBundle\\Entity\\Proprietaire' . "\0" . 'adresse', '' . "\0" . 'HTL\\ImmobilierBundle\\Entity\\Proprietaire' . "\0" . 'tel', '' . "\0" . 'HTL\\ImmobilierBundle\\Entity\\Proprietaire' . "\0" . 'email', '' . "\0" . 'HTL\\ImmobilierBundle\\Entity\\Proprietaire' . "\0" . 'codeBanque'];
        }
